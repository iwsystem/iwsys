                ...
                myValid: function()
                {
                    ...
                    $("#contact-cust-rep").validate({
                        ...
                        rules: {
                            ...
                            cust_rep_country: {required: true},
                        ...
                        messages: {
                            ...
                            cust_rep_phone: {number: "Should contain  only numbers"},
                            cust_rep_country: {required: "Select your country"},
                ...
                <div id="cust-rep-contact" class="modal hide fade in" style="display: none;">
                    ...
                    <div class="modal-body">
                        <form id="contact-cust-rep" class="contact-cust-rep" role="form" name ="contact-cust-rep" novalidate="novalidate">
                            ...
                            <label class="label" for="cust_rep_country">Your Country*</label><br>
                            <div>
                                <select name="cust_rep_country" id="cust_rep_country" class="input-large"></select><br>
                                    <script language="javascript">
                                        populateCountries("cust_rep_country");
                                    </script>
                            </div>
