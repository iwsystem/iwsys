...
<head>
    ...
    <title>IW System - Inactive Account</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    <div id="main_wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Inactive Account !!</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <p>Sorry, Your account is inactive on our system.</p>
                        <p>Please contact support immediately. Thanks</p>
                        </div>
                        <!-- /.End of Add New -->
                        <div class="row"></div>
                        <!-- Project History -->
