...
include_once("mailer/class.smtp.php");
        ...
        if ($uploadOk > 0) {
            if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
                ...
                try {
                    ...
                    $mail->AltBody    = "Hello " . ucfirst($first_name) . " " . ucfirst($last_name) . ", You have received a new message update from your project consultant . 
                    ...
                    $mail_body             = "Hello <b>" . ucfirst($first_name) ." " . ucfirst($last_name) . "</b>, <br><br>You have received a new message update from your project consultant. 
    ...
    $r_Db = null;    //  Redirect to the user profile page

    header("location:stf_project_inactive_detail.php?proj=$i_projID&status=$status"); 
