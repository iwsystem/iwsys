...
<head>
    ...
    <title>IW System Portal - Contact - Inprogress</title>
    <!-- Bootstrap Core CSS -->
...
<?php
    ...
    if (isset($_GET["status"])) {
        header('refresh:8; url=stf_cust_consult_contact_inprogress.php');
    }
?>
    <div id="main_wrapper">
        <!--  Navigation -->
        ...
        <div><br></div>
        <!--  Page body -->
        <?php include('tmpl/body_wrapper/stf_bdy_cust_consult_contact_inprogress_edit.php');  ?>
        <!--  Footer -->
