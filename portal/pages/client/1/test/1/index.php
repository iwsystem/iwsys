...
<body>
    ...
    <section id="error" class="container">
        <h1>Sorry, No Pages Yet</h1>
        <p><h3>Your project is yet to be deployed for testing and feedback. </h3></p>
        <p><h3>Your consultant will inform you when it is ready. Thanks</h3></p>

        <a class="btn btn-success" onclick="goBack()">Click To Go Back</a>
    </section>
    <!-- /404 error -->     
