...
<head>
    ...
    <title>IW System Portal - Client Admin  - Active</title>
    <!-- Bootstrap Core CSS -->
...
<?php
    ...
    if (isset($_GET["status"])) {
        header('refresh:8; url=stf_cust_admin_active.php');
    }
?>
    <div id="main_wrapper">
        <!--  Navigation -->
        ...
        <div><br></div>
        <!--  Page body -->
        <?php include('tmpl/body_wrapper/stf_bdy_cust_admin_active_edit.php');  ?>
        <!--  Footer -->
