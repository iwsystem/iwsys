<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Customer Issues - Pending</h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    This is a summarized list of all messages / issues sent by customer which are waiting to be worked on<br>
                    Click on each message on the table below, to access more details.  
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <h3 class="blue_header">List of Issues - Pending</h3>
                                ...
                                <?php
                                    ...
                                    try {
                                        ...
                                        foreach ($arr_resolved_contacts as $oResolved) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $first_name." ". $last_name . "</td>"."<td>". $oResolved["msg_title"] . "</td>"."<td>". $str_proj . "</td>" ."<td>". $oResolved["time"] . "</td>"."<td>" . "<a href='stf_cust_consult_contact_pending_edit.php?usr=$contact_id'> <i class='fa fa-adjust fa-fw'></i> </a>" . "</td>"; 
                                            echo "</tr>";
                                        }
