<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Unresolved Customer Contacts - PHONE </h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    This is a summarized list of all unresolved customer rep communications, for contacts via phone / email<br>
                                ...
                                <?php
                                    try {
                                        ...
                                        foreach ($arr_resolved_contacts as $oResolved) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $name. "</td>"."<td>". $subject . "</td>" ."<td>". $date . "</td>"."<td>" . "<a href='stf_cust_rep_phone_unresolved_edit.php?usr=$contact_id'> <i class='fa fa-eye fa-fw'></i> </a>" . "</td>"; 
                                            echo "</tr>";
                                        }                          
