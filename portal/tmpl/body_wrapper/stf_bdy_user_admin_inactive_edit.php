...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit User Information
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="col-lg-12"><br>
                                    <div class="row">
                                      ...
                                      <div class="col-md-8 personal-info">
                                        ...
                                        ?>
                                        <h3>User Info</h3>
                                        <form class="form-horizontal" role="form" method="post" action="stf_user_admin_inactive_edit_update.php">
                                          ...
                                          <div class="form-group">
                                            <label class="col-lg-3 control-label empDiv">Change User Sttus:</label>
                                            <div class="col-lg-6">
