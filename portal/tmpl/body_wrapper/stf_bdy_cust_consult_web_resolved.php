<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Resolved Consultant Contacts - WEB </h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    This is a summarized list of all resolved consultancy request communications, for contacts via web form<br>
                                ...
                                <?php
                                    try {
                                        ...
                                        foreach ($arr_resolved_contacts as $oResolved) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $name. "</td>"."<td>". $subject . "</td>" ."<td>". $date . "</td>" ."<td>". $outcome_message . "</td>" ."<td>" . "<a href='stf_cust_consult_web_resolved_edit.php?usr=$contact_id'> <i class='fa fa-eye fa-fw'></i> </a>" . "</td>"; 
                                            echo "</tr>";
                                        }                          
