                                ...
                                <?php
                                    try {
                                        ...
                                        foreach ($arr_active_user as $oActiveUser) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $first_name." ". $last_name . "</td>"."<td>". $created . "</td>" ."<td>". $arr_active_emp['job_position'] . "</td>" ."<td>" . "<a href='stf_emp_admin_active_edit.php?usr=$usr_id'> <i class='fa fa-edit fa-fw'></i> </a>" . "</td>"; 
                                            echo "</tr>";
                                        }                          
