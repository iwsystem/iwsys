<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Active Employees </h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    This is a summarized list of all active employees<br>
                    Click on each employee on the table below, to access more details.  
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <h3 class="blue_header">List of Active Employees</h3>
                                ...
                                <?php
                                    try {
                                        ...
                                        foreach ($arr_active_user as $oActiveUser) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $first_name." ". $last_name . "</td>"."<td>". $created . "</td>" . "<td>". $company . "</td>" ."<td>". $arr_active_emp['job_position'] . "</td>" ."<td>" . "<a href='stf_emp_admin_active_edit.php?usr=$usr_id'> <i class='fa fa-edit fa-fw'></i> </a>" . "</td>"; 
                                            echo "</tr>";
                                        }                          
