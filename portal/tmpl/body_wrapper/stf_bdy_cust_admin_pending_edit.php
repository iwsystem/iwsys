...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Pending Client <i class="fa fa-angle-right"></i> <?php echo ucfirst($arr_Details['firstname']) ." " .ucfirst($arr_Details['lastname']); ?>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="col-lg-12"><br>
                                    <div class="row">
                                      ...
                                      <div class="col-md-8 personal-info">
                                        ...
                                        ?>
                                        <h3>User Info</h3>
                                        <form class="form-horizontal" role="form" method="post" action="stf_cust_admin_pending_edit_update.php">
