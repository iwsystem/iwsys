...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Inactive Employee <i class="fa fa-angle-right"></i> <?php echo ucfirst($arr_Details['firstname']) ." " .ucfirst($arr_Details['lastname']); ?>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Here you can edit the registered information of the employee.<br>
                        </div>
                                ...
                                <div class="col-lg-12"><br>
                                    <div class="row">
                                      ...
                                      <div class="col-md-8 personal-info">
                                        ...
                                        ?>
                                        <h3>Employee Info</h3>
                                        <form class="form-horizontal" role="form" method="post" action="stf_emp_admin_inactive_edit_update.php">
                                          <div class="form-group">
                                            <label class="col-lg-3 control-label empDiv">Change Staff Role:</label>
                                            <div class="col-lg-6">
                                          ...
                                          <div class="form-group">
                                            <label class="col-lg-3 control-label empDiv">Job Position:</label>
                                            <div class="col-lg-8">
                                              <input name="job_position" class="form-control" type="text">
                                            </div>
                                          </div>                                            
                                          <div class="form-group">
