<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Customer Issues - Concluded</h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    This is a summarized list of all messages / issues sent by customer which have been worked on and sorted out<br>
                    Click on each message on the table below, to access more details.  
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <h3 class="blue_header">List of Issues - Concluded</h3>
                                ...
                                <?php
                                    ...
                                    try {
                                        if ($int_eID == 1) { //  If the logged in user is the administrator
                                            // We Will prepare SQL Query to retrieve all contact messages in the system
                                            $str_query = "  SELECT *
                                            ...
                                            // We Will prepare SQL Query to retrieve messages handled by a staff
                                            $str_query = "  SELECT *
                                                            FROM tbl_cust_consult_contact
                                                            WHERE  emp_id = :emp_id
                                                            AND status = 9
                                        ...
                                        foreach ($arr_resolved_contacts as $oResolved) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $first_name." ". $last_name . "</td>"."<td>". $oResolved["msg_title"] . "</td>"."<td>". $str_proj . "</td>" ."<td>". $oResolved["time"] . "</td>"."<td>" . "<a href='stf_cust_consult_contact_sorted_edit.php?usr=$contact_id'> <i class='fa fa-adjust fa-fw'></i> </a>" . "</td>"; 
                                            echo "</tr>";
                                        }
