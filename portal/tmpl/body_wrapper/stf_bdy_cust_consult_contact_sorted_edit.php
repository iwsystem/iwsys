...
try {
      ...
      $str_stmt->execute();   // For Executing prepared statement we will use below function
      $arr_proj = $str_stmt->fetch();    //  Storing the project's details in an array.
                                ...
                                <div class="col-lg-12"><br>
                                    <div class="row">
                                      ...
                                      <div class="col-md-8 personal-info">
                                        ...
                                        <form class="form-horizontal" role="form" method="post" action="stf_cust_consult_contact_sorted_edit_update.php">
