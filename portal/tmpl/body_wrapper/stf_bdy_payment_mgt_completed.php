<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Completed Payments </h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    This is a summarized list of all completed payments for projects you handled <br>
                                ...
                                <?php
                                    ...
                                    try {
                                        ...
                                        foreach ($arr_Project as $oProject) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $first_name." ". $last_name . "</td>"."<td>". $oProject["title"] . "</td>"."<td>". $oProject["cost"] . "</td>" . "<td>". $oProject["deadline"] . "</td>" . "<td>" . "<a href='stf_payment_mgt_completed_detail.php?proj=$i_projectID'> Payment Details </a>" . "</td>"; 
                                            echo "</tr>";
                                        }
