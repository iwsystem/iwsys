                                ...
                                <?php
                                    ...
                                    try {
                                        ...
                                        foreach ($arr_Project as $oProject) {
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . $first_name." ". $last_name . "</td>"."<td>". $oProject["title"] . "</td>"."<td>" . "<a href='pages/client/$i_custID/test/$i_projectID'>Project Page</a>" . "</td>" . "<td>" . "<a href='stf_project_mgt_detail.php?proj=$i_projectID'> Project History </a>" . "</td>"; 
                                            echo "</tr>";
                                        }
