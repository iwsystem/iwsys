<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Resolved Sales Contacts </h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    This is a summarized list of all resolved sales communications, for contacts via phone / post<br>
                                    ...
                                    try {
                                        ...
                                        foreach ($arr_resolved_contacts as $oResolved) {
                                            ...
                                            if ($int_eID == 1) { //  If the logged in user is the administrator
                                                ...
                                                echo "<tr>";
                                                echo "<td>" . $name. "</td>"."<td>". ucfirst($emp_firstname). " ".ucfirst($emp_lastname) . "</td>" ."<td>". $date . "</td>"."<td>". $outcome_message . "</td>" . "<td>" . "<a href='stf_sales_contact_resolved_edit.php?usr=$contact_id'> <i class='fa fa-eye fa-fw'></i> </a>" . "</td>"; 
                                                echo "</tr>";
                                            } else {
                                                echo "<tr>";
                                                echo "<td>" . $name. "</td>"."<td>". $company . "</td>" ."<td>". $date . "</td>"."<td>". $outcome_message . "</td>" . "<td>" . "<a href='stf_sales_contact_resolved_edit.php?usr=$contact_id'> <i class='fa fa-eye fa-fw'></i> </a>" . "</td>"; 
                                                echo "</tr>";
                                            }
                                        }                          
