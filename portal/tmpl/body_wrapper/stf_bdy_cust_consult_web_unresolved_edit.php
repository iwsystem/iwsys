...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">View Unresolved Message - WEB <i class="fa fa-angle-right"></i> <?php echo ucfirst($arr_Details['consult_name']); ?>
                    </h1>
                </div>
                                ...
                                <div class="col-lg-12"><br>
                                    <div class="row">
                                      ...
                                      <div class="col-md-8 personal-info">
                                        ...
                                        <form class="form-horizontal" role="form" method="post" action="stf_cust_consult_web_unresolved_edit_update.php">
