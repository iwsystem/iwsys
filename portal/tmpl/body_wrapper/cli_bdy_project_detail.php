<?php
        ...
        try {
            // We Will prepare SQL Query to retrieve all project updates for the project
            $str_query = "  SELECT *
                            ...
                            <div class="row">
                                <div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        ?>
                                        <form id="myForm" class="form-horizontal" role="form" method="post" action="cli_project_update.php" enctype="multipart/form-data">
