...
<head>
    ...
    <title>IW System Portal - Customer contact Sales</title>
    <!-- Bootstrap Core CSS -->
...
<?php
    ...
    if (isset($_GET["status"])) {
        header('refresh:8; url=stf_sales_contact_unresolved.php');
    }
?>
    <div id="main_wrapper">
        <!--  Navigation -->
        ...
        <div><br></div>
        <!--  Page body -->
        <?php include('tmpl/body_wrapper/stf_bdy_sales_contact_unresolved_edit.php');  ?>
        <!--  Footer -->
